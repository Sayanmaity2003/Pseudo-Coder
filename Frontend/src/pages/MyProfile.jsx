  ...
  return (
    userData && (
      <div className="max-w-lg flex flex-col gap-2 text-sm">
        ...
        {isEdit ? (
          <input
            className="bg-gray-50 text-3xl font-medium max-w-60 mt-4 border rounded"
            type="text"
            value={userData.name}
            onChange={(e) =>
        ...
        <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral">
            ...
            {isEdit ? (
              <input
                className="bg-gray-100 max-w-52 border rounded"
                type="text"
        ...
        <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral">
            ...
            {isEdit ? (
              <input
                className="max-w-28 bg-gray-100 border rounded"
                type="date"
                onChange={(e) =>
