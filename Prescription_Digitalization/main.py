...
st.markdown(
    ...
    .stTextArea {
        background-color: #0077B6;  /* Colore di sfondo della Text Area */
        color: #316989;              /* Colore del testo */
...
logo_path = "images/logo.png"  # Ensure this file is in the working directory

# Create layout with two columns
col1, col2 = st.columns([0.8, 2.5])  # Adjust width ratios as needed
...
with col2:
    ...
    st.title("Mediverse Prescription Digitalization")
...
st.markdown(
    ...
    """
       ...
       div.stButton > button:hover {
           background-color: #45a049 !important; /* Hover effect */
       }
       </style>
       """,
    unsafe_allow_html=True
